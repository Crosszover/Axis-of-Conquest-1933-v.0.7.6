...
def save_ipc_stats():
    ipc_stats = {
        ...
        "total_ipc_player1": label_total_ipc_player1.cget("text"),
        "used_ipc_player1": entry_used_ipc_player1.get(),
        "ipc_production_player1": entry_ipc_production_player1.get(),
        "total_ipc_player2": label_total_ipc_player2.cget("text"),
...
def load_ipc_stats():
    try:
        with open("ipc_stats.json", "r") as json_file:
            ...
            turn_counter_player1 = ipc_stats.get("turn_counter_player1", turn_counter_player1)
            turn_counter_player2 = ipc_stats.get("turn_counter_player2", turn_counter_player2)
            ...
            # Actualizar las etiquetas después de cargar los datos
            next_turn_player1()
            next_turn_player2()
...
def next_turn_player1():
    ...
    if ipc_production_player1_str:
        ...
        total_ipc_player1_str = label_total_ipc_player1.cget("text")
        if total_ipc_player1_str:
            total_ipc_player1 = int(total_ipc_player1_str)
            total_ipc_player1 += ipc_production_player1

            label_total_ipc_player1.config(text=str(total_ipc_player1))
...
def next_turn_player2():
    ...
    if ipc_production_player2_str:
        ...
        total_ipc_player2_str = label_total_ipc_player2.cget("text")
        if total_ipc_player2_str:
            total_ipc_player2 = int(total_ipc_player2_str)
            total_ipc_player2 += ipc_production_player2

            label_total_ipc_player2.config(text=str(total_ipc_player2))
...
def purchase_player1():
    ...
    if used_ipc_player1_str and total_ipc_player1_str:
        ...
        if used_ipc_player1 <= total_ipc_player1:
            ...
            label_total_ipc_player1.config(text=str(total_ipc_player1_result))
...
def purchase_player2():
    ...
    if used_ipc_player2_str and total_ipc_player2_str:
        ...
        if used_ipc_player2 <= total_ipc_player2:
            ...
            label_total_ipc_player2.config(text=str(total_ipc_player2_result))
...
label_total_ipc_player1 = tk.Label(window, text="0")
label_total_ipc_player1.grid(row=1, column=1, padx=10, pady=5)
...
label_total_ipc_player2 = tk.Label(window, text="0")
label_total_ipc_player2.grid(row=1, column=3, padx=10, pady=5)
